...
Version  : 5.110.0
Release  : 72
URL      : https://download.kde.org/stable/frameworks/5.110/kinit-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kinit-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kinit-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kinit-5.110.0
cd %{_builddir}/kinit-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694462053
mkdir -p clr-build
pushd clr-build
