...
Version  : 5.107.0
Release  : 69
URL      : https://download.kde.org/stable/frameworks/5.107/kinit-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/kinit-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kinit-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kinit-5.107.0
cd %{_builddir}/kinit-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686589671
mkdir -p clr-build
pushd clr-build
