...
Source0  : https://download.kde.org/stable/frameworks/5.102/kinit-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/kinit-5.102.0.tar.xz.sig
...
%prep
%setup -q -n kinit-5.102.0
cd %{_builddir}/kinit-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673911615
mkdir -p clr-build
pushd clr-build
